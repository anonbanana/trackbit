...
abstract class ProductRepository {
  Future<Result<List<Product>>> getAllProducts({String? categoryId, String? searchQuery});
  Future<Result<Product?>> getProductById(String id);
  Future<Result<Product?>> getProductByBarcode(String barcode);
  Future<Result<Product>> createProduct(Product product, {List<ProductAttribute>? attributes});
  Future<Result<Product>> updateProduct(Product product, {List<ProductAttribute>? attributes});
